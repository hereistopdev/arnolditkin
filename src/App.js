  ...
  return (
    <div className="App" id="home">
      ...
      <main id="MainZone">
        ...
        <section
          id="NoMatterWhat"
          class="nmw text-center nlf-middle dark-bg anm"
          universal_="true"
          data-onvisible="anm"
        >
          <figure>
            ...
            <picture class="" data-role="picture">
              <source
                media="(max-width: 550px)"
                srcset="
                https://d2a92m131axhse.cloudfront.net/assets/callout/wya-callout-bg-2-mobile.2305231442432.jpg
              "
              />
              <source
                media="(max-width: 1000px)"
                srcset="
                https://d2a92m131axhse.cloudfront.net/assets/callout/wya-callout-bg-2-tablet.2305231442432.jpg
              "
              />
              <img
                class="full"
